##Medoc managers should be the one to host because it is more convenient to initiative and leave running.

import medoc_api.communicator as communicator # type: ignore
