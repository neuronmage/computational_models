...
class TsaDevice:
    ...
    def __init__(self, auto_connect_port=True, preferences_path="./medoc_api/preferences.json") -> None:
        ...
        atexit.register(self.crash_closer) #closes port in case of Psychopy crash
    ...
    def crash_closer(self): #function to close port in case of Psychopy crash
        if self.connector.tunnel.is_open:
            self.connector.tunnel.close()
